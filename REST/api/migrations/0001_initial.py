# Generated by Django 4.0.6 on 2023-02-21 06:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.CharField(choices=[('first', 'Решен'), ('second', 'Не решен'), ('third', 'Заморожен')], default=io.open, max_length=20)),
